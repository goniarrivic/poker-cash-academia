...
const CTX = {
  ...
  cb_hu_ip:         { es: "Bote HU. Estás en posición (actúas último).", en: "HU pot. You are in position (act last)." },
  cb_hu_oop:        { es: "Bote HU. Estás fuera de posición (actúas primero).", en: "HU pot. You are out of position (act first)." },
  cb_hu_ip_nit:     { es: "Bote HU. Rival nit que foldea mucho. Estás en posición.", en: "HU pot. Nit villain who folds a lot. You are in position." },
  cb_hu_ip_fish:    { es: "Bote HU. Calling station (paga casi todo). Estás en posición.", en: "HU pot. Calling station (pays almost everything). You are in position." },
  cb_3way:          { es: "Bote 3-way (3 jugadores). Actúas primero.", en: "3-way pot. You act first." },
  cb_3way_ip:       { es: "Bote 3-way (3 jugadores). Actúas último.", en: "3-way pot. You act last." },
};
...
const CBET_SITUATIONS = [
  ...
  {id:301,type:"cbet",hand:"A♠K♣",board:"A♦7♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"TPTK en tablero seco rainbow. C-bet 33% para extraer valor de pares de 7, draws de as. No sobrevalores el tablero.", en:"TPTK on a dry rainbow board. C-bet 33% to extract value from sevens and weak aces. Don't over-size on a dry board."},
  {id:302,type:"cbet",hand:"K♥K♦",board:"Q♦8♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Overpair en tablero seco. C-bet 33% — el rival difícilmente tiene Q y el resto del rango foldea.",en:"Overpair on a dry board. C-bet 33% — villain rarely has Q and the rest of their range folds."},
  {id:303,type:"cbet",hand:"A♣Q♣",board:"A♠7♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Top pair buena kicker en A72r. C-bet 33% frecuente. Tablero totalmente seco, no hay draws.",en:"Top pair good kicker on A72r. C-bet 33% at high frequency. Completely dry board, no draws."},
  {id:304,type:"cbet",hand:"J♠J♦",board:"T♥8♦3♠",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Overpair en tablero bajo seco. C-bet 33% para proteger y extraer valor.",en:"Overpair on a low dry board. C-bet 33% to protect and extract value."},
  {id:305,type:"cbet",hand:"Q♣Q♦",board:"J♦7♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"QQ overpair en J72r. C-bet 33% — tienes ventaja de rango y el tablero es seco.",en:"QQ overpair on J72r. C-bet 33% — you have range advantage and the board is dry."},
  {id:306,type:"cbet",hand:"K♣T♣",board:"K♦8♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Top pair en tablero casi seco (un palo repetido). C-bet 33% extrae valor de manera eficiente.",en:"Top pair on a near-dry board (one suit repeated). C-bet 33% extracts value efficiently."},
  {id:307,type:"cbet",hand:"A♦5♦",board:"A♠9♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Pareja de ases con kicker baja en tablero seco. C-bet 33% — aún tienes top pair y range advantage.",en:"Pair of aces with low kicker on dry board. C-bet 33% — you still have top pair and range advantage."},
  {id:308,type:"cbet",hand:"T♠T♦",board:"8♦4♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_ip_nit", es:"TT overpair en tablero muy seco 842r vs nit. C-bet 33% — el nit foldea casi todo el rango.",en:"TT overpair on very dry 842r vs nit. C-bet 33% — the nit folds almost their entire range."},
  {id:309,type:"cbet",hand:"9♥9♦",board:"7♦5♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"99 overpair en tablero bajo seco. C-bet 33% con alta frecuencia.",en:"99 overpair on a low dry board. C-bet 33% at high frequency."},
  {id:310,type:"cbet",hand:"K♠J♠",board:"K♣7♦2♠",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Top pair con buena kicker en tablero seco. C-bet 33% — estándar.",en:"Top pair with good kicker on dry board. C-bet 33% — standard."},
  // ── IP, dry board, bluff C-bet small — 10 situations ──────────────────────
  {id:311,type:"cbet",hand:"J♣T♣",board:"A♦8♥2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Missed mano en tablero de as seco. C-bet 33% — el as favorece tu rango de apertura, el rival foldea mucho.",en:"Missed hand on dry ace-high board. C-bet 33% — the ace favors your opening range, villain folds a lot."},
  ...
  {id:313,type:"cbet",hand:"A♦3♦",board:"K♠9♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"A3s sin par en tablero seco. C-bet 33% — backdoor flush draw + blocker al as da extra fold equity.",en:"A3s no pair on dry board. C-bet 33% — backdoor flush draw + ace blocker gives extra fold equity."},
  {id:314,type:"cbet",hand:"K♣Q♣",board:"A♦8♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip_nit", es:"Sin par en tablero de as vs nit. C-bet 33% — el nit foldea todos sus pares de 8 y 2.",en:"No pair on ace board vs nit. C-bet 33% — the nit folds all their eights and twos."},
  {id:315,type:"cbet",hand:"T♠8♠",board:"A♥6♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Missed suited connector en tablero de as seco. C-bet 33% — tablero favorece abridor, fold equity suficiente.",en:"Missed suited connector on dry ace board. C-bet 33% — board favors opener, sufficient fold equity."},
  {id:316,type:"cbet",hand:"7♦6♦",board:"K♠9♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_ip_nit", es:"Sin nada en tablero desconectado vs nit. C-bet 33% — el nit foldea casi todo excepto KX.",en:"Nothing on disconnected board vs nit. C-bet 33% — the nit folds almost everything except KX."},
  {id:317,type:"cbet",hand:"A♠2♠",board:"Q♦8♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"A2s sin par en tablero de dama seco. C-bet 33% — blocker al as, backdoor draw, rango abridor fuerte aquí.",en:"A2s no pair on dry queen board. C-bet 33% — ace blocker, backdoor draw, opener's range is strong here."},
  {id:318,type:"cbet",hand:"J♦9♦",board:"A♠7♥2♦",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Mano perdida en tablero de as seco. C-bet 33% — fold equity alta vs rangos de call del BB.",en:"Missed hand on dry ace board. C-bet 33% — high fold equity vs BB calling ranges."},
  {id:319,type:"cbet",hand:"K♥4♥",board:"Q♠8♦3♣",players:1,open:true, size:"small",ctx:"cb_hu_ip_nit", es:"K4s sin par vs nit en tablero seco. C-bet 33% — el nit foldea la mayoría del rango.",en:"K4s no pair vs nit on dry board. C-bet 33% — the nit folds most of their range."},
  ...
  {id:321,type:"cbet",hand:"A♠K♠",board:"A♠T♠8♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"TPTK con nut flush draw en tablero mojado. C-bet 67% — construyes bote con draw + valor, cargas al rival por sus draws.",en:"TPTK with nut flush draw on wet board. C-bet 67% — build the pot with draw + value, charge villain for their draws."},
  {id:322,type:"cbet",hand:"K♣K♦",board:"J♠T♠9♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"KK overpair en tablero muy conectado. C-bet 67% — mano fuerte pero muchos draws por detrás, cobra por ellos.",en:"KK overpair on very connected board. C-bet 67% — strong hand but many draws behind, charge for them."},
  {id:323,type:"cbet",hand:"9♥9♠",board:"9♦8♠7♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set de 9s en tablero monotone-style. C-bet 67% — mano de valor muy fuerte pero tablero peligroso con draws.",en:"Set of nines on a very connected board. C-bet 67% — very strong value hand but dangerous board full of draws."},
  {id:324,type:"cbet",hand:"J♦T♦",board:"J♠9♠8♥",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + gutshot en tablero muy mojado. C-bet 67% — protege tu mano y construye bote con equity.",en:"Top pair + gutshot on very wet board. C-bet 67% — protect your hand and build pot with equity."},
  {id:325,type:"cbet",hand:"A♥Q♥",board:"Q♠J♥T♥",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + nut flush draw en tablero de rainbow a tres colores. C-bet 67% — draw potente + valor.",en:"Top pair + nut flush draw on rainbow three-suit board. C-bet 67% — strong draw + value."},
  {id:326,type:"cbet",hand:"K♠Q♠",board:"Q♥J♠T♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + flush draw en tablero conectado peligroso. C-bet 67% — extrae valor y cobra por los draws.",en:"Top pair + flush draw on dangerous connected board. C-bet 67% — extract value and charge for draws."},
  {id:327,type:"cbet",hand:"T♥9♥",board:"T♠9♠8♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Dos pares en tablero mojado. C-bet 67% — mano fuerte pero tablero peligroso. Cobra a los draws ya.",en:"Two pair on wet board. C-bet 67% — strong hand but dangerous board. Charge the draws now."},
  {id:328,type:"cbet",hand:"8♣8♦",board:"8♠7♠6♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set en tablero muy conectado y con flush draw. C-bet 67% — necesitas cobrar a los draws ya, no puedes dormir.",en:"Set on a very connected board with flush draw. C-bet 67% — need to charge draws now, can't slow-play."},
  {id:329,type:"cbet",hand:"A♣J♣",board:"J♥9♣8♣",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + nut flush draw en tablero conectado. C-bet 67% — draw combo potentísimo, construye el bote.",en:"Top pair + nut flush draw on connected board. C-bet 67% — powerful combo draw, build the pot."},
  {id:330,type:"cbet",hand:"Q♦Q♣",board:"Q♠J♦T♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set de reinas en tablero muy peligroso. C-bet 67% — set > draws pero cobra ya, el turn puede ser terrible.",en:"Set of queens on very dangerous board. C-bet 67% — set beats draws but charge now, the turn can be terrible."},
  // ── IP, should CHECK — 15 situations ──────────────────────────────────────
  {id:331,type:"cbet",hand:"J♣T♣",board:"9♠8♠7♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"JT en tablero 987 = escalera completada (J-T-9-8-7). Mano muy fuerte. C-bet 67% — tienes el nuts straight pero el tablero es peligroso con flush draw. Cobra ya.",en:"JT on 987 board = completed straight (J-T-9-8-7). Very strong hand. C-bet 67% — you have the nuts straight but the board is dangerous with a flush draw. Charge now."},
  {id:332,type:"cbet",hand:"K♣J♦",board:"8♠7♠6♦",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Sin par en tablero muy mojado. El rango del caller conecta mejor aquí. Checkea y evalúa.",en:"No pair on very wet board. Caller's range connects better here. Check and evaluate."},
  {id:333,type:"cbet",hand:"A♦Q♦",board:"K♠Q♠J♠",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Tablero monotone de picas. Par de damas pero el rival puede tener flush o straight. Sin equidad real. Checkea.",en:"Monotone spade board. Pair of queens but villain can have flush or straight. No real edge. Check."},
  {id:334,type:"cbet",hand:"7♠6♠",board:"A♣K♦Q♠",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Gutshot en tablero de tres cartas altas. Poca fold equity y mucha equidad del rival. Checkea.",en:"Gutshot on three-high-card board. Low fold equity and high villain equity. Check."},
  {id:335,type:"cbet",hand:"5♦5♣",board:"9♠8♠7♦",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Par de 5s underpair en tablero muy conectado. Sin equity y mucho riesgo. Checkea.",en:"Pair of fives underpair on very connected board. No equity and high risk. Check."},
  {id:336,type:"cbet",hand:"A♠2♠",board:"T♠9♠8♦",players:1,open:false,size:null,ctx:"cb_hu_ip_fish",   es:"A2s en tablero conectado vs calling station. No bluffees a calling stations. Sin hand fuerte aquí. Checkea.",en:"A2s on connected board vs calling station. Don't bluff calling stations. No strong hand here. Check."},
  {id:337,type:"cbet",hand:"K♣Q♣",board:"J♠T♠9♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"KQ en tablero J♠T♠9♠ = escalera de rey (K-Q-J-T-9). Tienes el nuts straight aunque el tablero sea monotone de picas. C-bet 67% — cobra al rival que tiene el flush draw o draws al straight inferior.",en:"KQ on J♠T♠9♠ board = king-high straight (K-Q-J-T-9). You have the nut straight even though the board is monotone spades. C-bet 67% — charge the villain who has the flush draw or inferior straight draws."},
  {id:338,type:"cbet",hand:"Q♥J♥",board:"A♠K♠Q♦",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Par de damas en tablero de as-rey peligroso. El rival tiene muchos AK, AQ, KQ. Checkea y evalúa.",en:"Pair of queens on dangerous ace-king board. Villain has many AK, AQ, KQ. Check and evaluate."},
  {id:339,type:"cbet",hand:"T♦9♦",board:"A♠K♠Q♠",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Mano perdida en tablero monotone de tres broadways. Sin flush de picas. Checkea.",en:"Missed hand on monotone three-broadway board. No spade flush. Check."},
  {id:340,type:"cbet",hand:"6♣6♦",board:"K♠Q♦J♠",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"Underpair en tablero de tres cartas altas conectadas. Sin valor real, sin fold equity. Checkea.",en:"Underpair on three connected high cards. No real value, no fold equity. Check."},
  // ── OOP, dry board, should C-bet ── 10 situations ─────────────────────────
  {id:341,type:"cbet",hand:"A♠K♦",board:"A♥7♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"TPTK OOP en tablero seco. C-bet 33% — aún tienes la iniciativa y la mano más fuerte. El tablero es seco.",en:"TPTK OOP on dry board. C-bet 33% — you still have initiative and the strongest hand. Dry board."},
  {id:342,type:"cbet",hand:"K♣K♥",board:"Q♦8♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"KK overpair OOP en tablero seco. C-bet 33% — construye bote con mano fuerte. No hay draws.",en:"KK overpair OOP on dry board. C-bet 33% — build pot with strong hand. No draws."},
  {id:343,type:"cbet",hand:"A♦J♦",board:"A♠9♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"Top pair OOP en tablero seco. C-bet 33% para extraer valor.",en:"Top pair OOP on dry board. C-bet 33% to extract value."},
  {id:344,type:"cbet",hand:"Q♠Q♦",board:"J♣7♦2♠",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"QQ overpair OOP en tablero seco de J. C-bet 33% — extraes valor de JX y manos más débiles.",en:"QQ overpair OOP on dry jack-high board. C-bet 33% — extract value from JX and weaker hands."},
  {id:345,type:"cbet",hand:"K♦Q♦",board:"K♣8♦3♠",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"Top pair OOP en tablero seco. C-bet 33% por valor.",en:"Top pair OOP on dry board. C-bet 33% for value."},
  {id:346,type:"cbet",hand:"A♥T♥",board:"A♦6♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"Top pair + backdoor flush draw OOP en tablero seco. C-bet 33% — valor + algo de potencial.",en:"Top pair + backdoor flush draw OOP on dry board. C-bet 33% — value + some potential."},
  {id:347,type:"cbet",hand:"J♠J♦",board:"T♦6♣2♠",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"JJ overpair OOP en tablero bajo seco. C-bet 33% — mano fuerte en tablero favorable.",en:"JJ overpair OOP on low dry board. C-bet 33% — strong hand on favorable board."},
  {id:348,type:"cbet",hand:"T♣T♦",board:"8♠5♦2♣",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"TT overpair OOP en tablero muy seco. C-bet 33% con alta frecuencia — nadie tiene nada aquí.",en:"TT overpair OOP on very dry board. C-bet 33% at high frequency — nobody has anything here."},
  {id:349,type:"cbet",hand:"A♣8♣",board:"A♦7♣3♥",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"Top pair buena kicker OOP en tablero seco. C-bet 33% por valor.",en:"Top pair good kicker OOP on dry board. C-bet 33% for value."},
  {id:350,type:"cbet",hand:"Q♦Q♣",board:"9♦5♣2♥",players:1,open:true, size:"small",ctx:"cb_hu_oop",    es:"QQ overpair OOP en tablero muy bajo. C-bet 33% — tienes la mano más fuerte probable.",en:"QQ overpair OOP on very low board. C-bet 33% — you likely have the strongest hand."},
  // ── OOP, should CHECK ── 15 situations ────────────────────────────────────
  {id:351,type:"cbet",hand:"K♠Q♠",board:"9♠8♠7♦",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Mano perdida OOP en tablero muy mojado. Sin equidad real. El rival tiene mejor posición y rango que conecta. Checkea.",en:"Missed hand OOP on very wet board. No real equity. Villain has better position and connecting range. Check."},
  {id:352,type:"cbet",hand:"A♦Q♦",board:"J♠T♠9♦",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Sin par OOP en tablero extremadamente conectado. No apostar — checkea y evalúa la apuesta del rival.",en:"No pair OOP on extremely connected board. Don't bet — check and evaluate villain's bet."},
  {id:353,type:"cbet",hand:"J♣T♣",board:"A♠K♦Q♦",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"JT en tablero A-K-Q = broadway straight (A-K-Q-J-T). Tienes el nuts straight OOP. C-bet 67% — incluso OOP, la mano es demasiado fuerte para checkear. Cobra al rival que tiene draws o pares de broadway.",en:"JT on A-K-Q board = broadway straight (A-K-Q-J-T). You have the nut straight OOP. C-bet 67% — even OOP, the hand is too strong to check. Charge the villain who has draws or broadway pairs."},
  {id:354,type:"cbet",hand:"7♦6♦",board:"K♠Q♣J♦",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Missed suited connector OOP en tablero de tres cartas altas. Sin fold equity relevante. Checkea.",en:"Missed suited connector OOP on three-high-card board. No relevant fold equity. Check."},
  {id:355,type:"cbet",hand:"9♣8♣",board:"A♦K♣Q♥",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Sin nada OOP en tablero de tres cartas altas. Bluffear aquí es tirar fichas. Checkea.",en:"Nothing OOP on three-high-card board. Bluffing here is wasting chips. Check."},
  {id:356,type:"cbet",hand:"A♠5♠",board:"8♠7♠6♦",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"A5s OOP en tablero muy conectado que favorece al caller. Backdoor flush no es suficiente. Checkea.",en:"A5s OOP on very connected board favoring the caller. Backdoor flush isn't enough. Check."},
  {id:357,type:"cbet",hand:"K♥J♥",board:"T♠9♠8♦",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Gutshot OOP en tablero muy conectado. Poca fold equity. El rival tiene más equity aquí. Checkea.",en:"Gutshot OOP on very connected board. Low fold equity. Villain has more equity here. Check."},
  {id:358,type:"cbet",hand:"Q♣J♦",board:"A♠K♠Q♣",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Par de damas OOP en tablero peligroso. El rival puede tener AK, AQ, KQ, flush draw. Checkea.",en:"Pair of queens OOP on dangerous board. Villain can have AK, AQ, KQ, flush draw. Check."},
  {id:359,type:"cbet",hand:"5♠5♦",board:"J♣T♣9♥",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"Underpair OOP en tablero muy conectado. Sin equity real. Checkea.",en:"Underpair OOP on very connected board. No real equity. Check."},
  {id:360,type:"cbet",hand:"A♦2♦",board:"K♠Q♠J♦",players:1,open:false,size:null,ctx:"cb_hu_ip_fish",   es:"A2s sin par en tablero de tres cartas altas vs calling station. No bluffees. Checkea.",en:"A2s no pair on three-high-card board vs calling station. Don't bluff. Check."},
  // ── OOP, wet board, C-bet large — 5 situations ────────────────────────────
  {id:361,type:"cbet",hand:"A♠A♦",board:"J♠T♠9♦",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"AA OOP en tablero extremadamente peligroso. C-bet 67% — mano premium pero debes cobrar a los draws YA.",en:"AA OOP on extremely dangerous board. C-bet 67% — premium hand but you must charge the draws NOW."},
  {id:362,type:"cbet",hand:"K♣K♦",board:"9♠8♣7♠",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"KK OOP en tablero mojado. C-bet 67% — overpair fuerte pero tablero peligroso. Cobra a los draws.",en:"KK OOP on wet board. C-bet 67% — strong overpair but dangerous board. Charge the draws."},
  {id:363,type:"cbet",hand:"T♠T♦",board:"T♣9♣8♦",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"Set de tens OOP en tablero conectado. C-bet 67% — set fuerte pero necesita cobrar a los draws.",en:"Set of tens OOP on connected board. C-bet 67% — strong set but needs to charge the draws."},
  {id:364,type:"cbet",hand:"A♥J♥",board:"J♠T♥9♠",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"Top pair + flush draw OOP en tablero peligroso. C-bet 67% — draw + valor justifican tamaño grande.",en:"Top pair + flush draw OOP on dangerous board. C-bet 67% — draw + value justify large size."},
  {id:365,type:"cbet",hand:"Q♠Q♦",board:"Q♣J♠T♣",players:1,open:true, size:"large",ctx:"cb_hu_oop",    es:"Set OOP en tablero con straight draws y flush draw. C-bet 67% — cobra YA, no puedes dormir este set.",en:"Set OOP on board with straight and flush draws. C-bet 67% — charge NOW, can't slow-play this set."},
  // ── Multiway, should CHECK — 10 situations ────────────────────────────────
  {id:366,type:"cbet",hand:"A♣J♣",board:"K♦8♣3♠",players:2,open:false,size:null,ctx:"cb_3way",         es:"Sin par en tablero seco 3-way. Bluffear multiway tiene poca fold equity. Checkea.",en:"No pair on dry board 3-way. Bluffing multiway has low fold equity. Check."},
  {id:367,type:"cbet",hand:"J♠T♠",board:"A♦9♣4♥",players:2,open:false,size:null,ctx:"cb_3way",         es:"Mano perdida 3-way. En botes de 3 jugadores el bluff rara vez funciona. Checkea.",en:"Missed hand 3-way. In 3-player pots bluffing rarely works. Check."},
  {id:368,type:"cbet",hand:"7♦6♦",board:"Q♦J♣T♠",players:2,open:false,size:null,ctx:"cb_3way",         es:"Mano perdida 3-way en tablero conectado. Checkea — alguien tiene algo aquí.",en:"Missed hand 3-way on connected board. Check — someone has something here."},
  {id:369,type:"cbet",hand:"K♣Q♣",board:"A♠9♦5♣",players:2,open:false,size:null,ctx:"cb_3way",         es:"Sin par en tablero de as 3-way. Checkea — fold equity mínima con 2 callers.",en:"No pair on ace board 3-way. Check — minimal fold equity with 2 callers."},
  {id:370,type:"cbet",hand:"9♥9♠",board:"A♦K♣8♦",players:2,open:false,size:null,ctx:"cb_3way",         es:"Underpair en tablero de dos cartas altas 3-way. Sin valor real aquí. Checkea.",en:"Underpair on two-high-card board 3-way. No real value here. Check."},
  {id:371,type:"cbet",hand:"A♦3♦",board:"T♠9♠8♣",players:2,open:false,size:null,ctx:"cb_3way",         es:"Par de ases pero tablero muy conectado 3-way. El riesgo es demasiado alto. Checkea.",en:"Pair of aces but very connected board 3-way. Risk is too high. Check."},
  {id:372,type:"cbet",hand:"K♠J♦",board:"Q♣J♠T♦",players:2,open:false,size:null,ctx:"cb_3way",         es:"Par de J en tablero conectado 3-way. Alguien tiene KX, AX, 9X. Checkea.",en:"Pair of jacks on connected board 3-way. Someone has KX, AX, 9X. Check."},
  {id:373,type:"cbet",hand:"T♣9♣",board:"A♠K♦Q♣",players:2,open:false,size:null,ctx:"cb_3way",         es:"Gutshot en tablero de tres cartas altas 3-way. Sin fold equity, sin valor. Checkea.",en:"Gutshot on three-high-card board 3-way. No fold equity, no value. Check."},
  {id:374,type:"cbet",hand:"6♣6♦",board:"K♦Q♠J♣",players:2,open:false,size:null,ctx:"cb_3way",         es:"Underpair en tablero de tres cartas altas 3-way. Sin equity real. Checkea.",en:"Underpair on three-high-card board 3-way. No real equity. Check."},
  {id:375,type:"cbet",hand:"5♠4♠",board:"A♦T♣7♠",players:2,open:false,size:null,ctx:"cb_3way",         es:"Mano especulativa sin par ni draw real 3-way. Checkea — bote multiway requiere manos fuertes.",en:"Speculative hand with no pair or real draw 3-way. Check — multiway pot requires strong hands."},
  // ── Multiway, C-bet for value — 5 situations ──────────────────────────────
  {id:376,type:"cbet",hand:"A♠A♣",board:"K♦8♣3♠",players:2,open:true, size:"small",ctx:"cb_3way",      es:"AA en tablero seco 3-way. C-bet 33% — mano premium que merece apostar incluso multiway.",en:"AA on dry board 3-way. C-bet 33% — premium hand worth betting even multiway."},
  {id:377,type:"cbet",hand:"K♠K♦",board:"Q♦7♣2♥",players:2,open:true, size:"small",ctx:"cb_3way",      es:"KK overpair en tablero seco 3-way. C-bet 33% — extrae valor aunque el bote sea multiway.",en:"KK overpair on dry board 3-way. C-bet 33% — extract value even in multiway pot."},
  {id:378,type:"cbet",hand:"8♠8♦",board:"8♣4♦2♥",players:2,open:true, size:"large",ctx:"cb_3way",      es:"Set de 8s en tablero seco 3-way. C-bet 67% — set poderoso, construye el bote agresivamente.",en:"Set of eights on dry board 3-way. C-bet 67% — powerful set, build pot aggressively."},
  {id:379,type:"cbet",hand:"A♥K♥",board:"A♦9♣3♥",players:2,open:true, size:"small",ctx:"cb_3way_ip",   es:"TPTK IP 3-way en tablero seco. C-bet 33% — mano fuerte que merece apostar en posición.",en:"TPTK IP 3-way on dry board. C-bet 33% — strong hand worth betting in position."},
  {id:380,type:"cbet",hand:"Q♣Q♦",board:"Q♠7♦2♣",players:2,open:true, size:"large",ctx:"cb_3way",      es:"Set de damas en tablero seco 3-way. C-bet 67% — set top en tablero bueno, construye el bote.",en:"Set of queens on dry board 3-way. C-bet 67% — top set on good board, build the pot."},
  // ── Mixed / Edge cases — 20 situations ────────────────────────────────────
  {id:381,type:"cbet",hand:"A♦K♦",board:"K♠T♦5♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Top pair (reyes) IP en tablero semi-seco. C-bet 33% — mano fuerte en tablero manejable.",en:"Top pair (kings) IP on semi-dry board. C-bet 33% — strong hand on manageable board."},
  {id:382,type:"cbet",hand:"J♥J♦",board:"9♠8♠7♦",players:1,open:false,size:null,ctx:"cb_hu_ip",        es:"JJ overpair pero tablero extremadamente peligroso. Sin fold equity, el rival conecta bien. Checkea.",en:"JJ overpair but extremely dangerous board. No fold equity, villain connects well. Check."},
  {id:383,type:"cbet",hand:"K♣Q♦",board:"K♥Q♦J♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Dos pares top IP en tablero conectado. C-bet 67% — construye bote con mano fuerte pero peligrosa.",en:"Top two pair IP on connected board. C-bet 67% — build pot with strong but vulnerable hand."},
  {id:384,type:"cbet",hand:"A♠4♠",board:"A♦5♠2♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Top pair + wheel draw (A2345) IP en tablero seco. C-bet 33% — valor + potencial de straight.",en:"Top pair + wheel draw (A2345) IP on dry board. C-bet 33% — value + straight potential."},
  {id:385,type:"cbet",hand:"T♦8♦",board:"9♦7♦6♣",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Straight abierto + flush draw IP en tablero conectado. C-bet 67% — monster combo draw.",en:"Open-ended straight draw + flush draw IP on connected board. C-bet 67% — monster combo draw."},
  {id:386,type:"cbet",hand:"Q♠J♠",board:"T♠9♣8♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Straight completado (Q high) IP en tablero conectado. C-bet 67% — mano fuerte, extrae valor.",en:"Completed straight (Q high) IP on connected board. C-bet 67% — strong hand, extract value."},
  {id:387,type:"cbet",hand:"7♣7♦",board:"7♠6♦5♣",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set de 7s en tablero conectado. C-bet 67% — set poderoso pero tablero peligroso con draws.",en:"Set of sevens on connected board. C-bet 67% — powerful set but dangerous board with draws."},
  {id:388,type:"cbet",hand:"A♣9♣",board:"9♦8♣7♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + flush draw IP en tablero mojado. C-bet 67% — semi-bluff con mucha equity.",en:"Top pair + flush draw IP on wet board. C-bet 67% — semi-bluff with lots of equity."},
  {id:389,type:"cbet",hand:"K♦K♣",board:"A♠T♦5♣",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"KK OOP pero hay un as en el tablero. Mucho riesgo de que el rival tenga AX. Checkea.",en:"KK OOP but there's an ace on the board. High risk villain has AX. Check."},
  {id:390,type:"cbet",hand:"5♦5♣",board:"A♦5♠2♣",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set de 5s en tablero de as. C-bet 67% — set poderoso, cobra al rival que tiene AX.",en:"Set of fives on ace board. C-bet 67% — powerful set, charge the villain who has AX."},
  {id:391,type:"cbet",hand:"Q♣T♣",board:"Q♦T♦8♣",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Dos pares top IP en tablero con flush draw. C-bet 67% — mano fuerte pero vulnerable a flushes.",en:"Top two pair IP on board with flush draw. C-bet 67% — strong but vulnerable to flushes."},
  {id:392,type:"cbet",hand:"A♠8♣",board:"8♦8♠3♣",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Trips (8s) + top kicker. C-bet 33% small — tablero seco, no hay draws, extrae valor tranquilamente.",en:"Trips (eights) + top kicker. C-bet 33% small — dry board, no draws, extract value calmly."},
  {id:393,type:"cbet",hand:"J♠9♠",board:"J♦9♣4♥",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Dos pares top IP en tablero con possible flush draws en colores. C-bet 67% — protege tu mano.",en:"Top two pair IP on board with potential flush draws. C-bet 67% — protect your hand."},
  {id:394,type:"cbet",hand:"K♥8♥",board:"K♦8♦4♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Dos pares IP en tablero con dos palos repetidos. C-bet 67% — cobra a los flush draws.",en:"Two pair IP on board with two repeated suits. C-bet 67% — charge the flush draws."},
  {id:395,type:"cbet",hand:"A♦Q♦",board:"Q♠8♦3♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Top pair + nut flush draw IP. C-bet 67% — draw + valor es la combinación ideal para bet grande.",en:"Top pair + nut flush draw IP. C-bet 67% — draw + value is the ideal combination for a large bet."},
  {id:396,type:"cbet",hand:"T♠T♦",board:"T♣T♥3♠",players:1,open:true, size:"small",ctx:"cb_hu_ip",     es:"Quads (cuadra de tens). C-bet 33% pequeño — tablero ultra-seco, el rival no tiene nada. Extrae valor lentamente.",en:"Quads (four tens). C-bet 33% small — ultra-dry board, villain has nothing. Extract value slowly."},
  {id:397,type:"cbet",hand:"A♥K♣",board:"A♣J♠T♦",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"TPTK + draw en tablero conectado peligroso. C-bet 67% — tienes valor pero el tablero es peligroso.",en:"TPTK + draw on dangerous connected board. C-bet 67% — you have value but the board is dangerous."},
  {id:398,type:"cbet",hand:"3♦3♣",board:"A♦K♣3♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Set de 3s en tablero de dos cartas altas. C-bet 67% — set poderoso, cobra a las manos altas.",en:"Set of threes on two-high-card board. C-bet 67% — powerful set, charge the high-card hands."},
  {id:399,type:"cbet",hand:"Q♦Q♣",board:"A♦K♣5♠",players:1,open:false,size:null,ctx:"cb_hu_oop",       es:"QQ OOP en tablero de A-K. El rival probablemente tiene AX o KX. Peligro real. Checkea y evalúa.",en:"QQ OOP on A-K board. Villain likely has AX or KX. Real danger. Check and evaluate."},
  {id:400,type:"cbet",hand:"8♣7♣",board:"J♣T♣9♠",players:1,open:true, size:"large",ctx:"cb_hu_ip",     es:"Straight + flush draw (monster combo). C-bet 67% — mano muy fuerte y draw adicional, construye el bote.",en:"Straight + flush draw (monster combo). C-bet 67% — very strong hand with additional draw, build the pot."},
];
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div style={{ background: "#0d0f1a", border: "1px solid #1e2235", borderRadius: 14, padding: "20px", marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 13, color: "#8b8fa8", borderTop: "1px solid #2a2d3a", paddingTop: 12 }}>
          <span style={{ color: "#c9a84c", fontWeight: 600 }}>{p.contextLabel}: </span>{lang === "es" ? ctx.es : ctx.en}
        </div>
      </div>
